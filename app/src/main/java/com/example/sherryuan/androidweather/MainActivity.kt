...
class MainActivity : AppCompatActivity(), WeatherResponseListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        weather_button.setOnClickListener { openWeatherMapApi.fetchWeather(TEXAS_LAT, TEXAS_LONG) }
    }
    ...
    override fun onWeatherResponse(openWeatherResponse: OpenWeatherResponse) =
            runOnUiThread { weather_text.text = getString(R.string.temperature_text, openWeatherResponse.main.temp - 273.15).format(2) }
}
